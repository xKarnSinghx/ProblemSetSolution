...
Suffix Sort Problem Code: ICM0001
Solved
Submit (Practice)
The match is set and your team is ready to win!
The team has N
players, each with the ability Ai.
...
void solve()
{
	...
	if (d == n - 1) cout << "yes" << endl << 0 ;
	else if (l == 1 && a[n - 1] <= a[0]) cout << "yes" << endl << 1 ;
	else if (l == n - 1) cout << "yes" << endl << n - 1 ;
	else cout << "no" ;
