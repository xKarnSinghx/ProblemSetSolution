...
void solve()
{
	...
	if (n / 10 < 1)
		...
		if (n / 10 == ceils(n, 10))
			cout << (ceils(n, 10) + 1) * 10 - t;
		else
			cout << ceils(n, 10) * 10 - t;
	}
	else if (n / 100 < 10) {
		if (n / 100 == ceils(n, 100))
			cout << (ceils(n, 100) + 1) * 100 - t;
		else
			cout << ceils(n, 100) * 100 - t;
	}
	else if (n / 1000 < 10) {
		if (n / 1000 == ceils(n, 1000))
			cout << (ceils(n, 1000) + 1) * 1000 - t;
		else
			cout << ceils(n, 1000) * 1000 - t;
	}
	else if (n / 10000 < 10) {
		if (n / 10000 == ceils(n, 10000))
			cout << (ceils(n, 10000) + 1) * 10000 - t;
		else
			cout << ceils(n, 10000) * 10000 - t;
	}
	else if (n / 100000 < 10) {
		if (n / 100000 == ceils(n, 100000))
			cout << (ceils(n, 100000) + 1) * 100000 - t;
		else
			cout << ceils(n, 100000) * 100000 - t;
	}
	else if (n / 1000000 < 10) {
		if (n / 1000000 == ceils(n, 1000000))
			cout << (ceils(n, 1000000) + 1) * 1000000 - t;
		else
			cout << ceils(n, 1000000) * 1000000 - t;
	}
	else if (n / 10000000 < 10) {
		if (n / 10000000 == ceils(n, 10000000))
			cout << (ceils(n, 10000000) + 1) * 10000000 - t;
		else
			cout << ceils(n, 10000000) * 10000000 - t;
	}
	else if (n / 100000000 < 10) {
		if (n / 100000000 == ceils(n, 100000000))
			cout << (ceils(n, 100000000) + 1) * 100000000 - t;
		else
			cout << ceils(n, 100000000) * 100000000 - t;
	}
	else if (n / 1000000000 < 10) {
		if (n / 1000000000 == ceils(n, 1000000000))
			cout << (ceils(n, 1000000000) + 1) * 1000000000 - t;
		else
			cout << ceils(n, 1000000000) * 1000000000 - t;
	}
}
