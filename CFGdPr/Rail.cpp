...
The first line of input must contain two integers n,m (2≤n≤200, 1≤m≤500) — the number of stations and tracks.

The next m lines of input must contain exactly 3 space-separated integers ui, vi, li (1≤ui,vi≤n, ui≠vi, 1≤li≤106) — the endpoints and the length of the i-th track.
