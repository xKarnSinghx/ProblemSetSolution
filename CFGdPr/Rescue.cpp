...
Suppose a string s1s2s3…sn is given. Then its "expansion" is defined as the sequence of strings s1, s1s2, ..., s1s2…sn, s2, s2s3, ..., s2s3…sn, s3, s3s4, ..., sn−1sn, sn. For example, the "expansion" the string 'abcd' will be the following sequence of strings: 'a', 'ab', 'abc', 'abcd', 'b', 'bc', 'bcd', 'c', 'cd', 'd'.
