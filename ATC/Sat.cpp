...
We say a string 
T
 to be unsatisfied when it matches one of 
S
1
,
S
...
S
N
 regardless of whether we add an ! at the beginning of 
T
.
...
S
i
 is a non-empty string consisting of lowercase English letters, with zero or one ! added at the beginning.
